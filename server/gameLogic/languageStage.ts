...
const STAGE_REPLACEMENTS: Record<string, Record<LanguageStage, string>> = {
  ...
  "power growth": { 1: "practice", 2: "training", 3: "growth", 4: "power growth" },
  "Daily Ritual": { 1: "Step", 2: "Habit", 3: "Habit", 4: "Daily Ritual" },
  "daily ritual": { 1: "step", 2: "habit", 3: "habit", 4: "daily ritual" },
  "Daily Rituals": { 1: "Steps", 2: "Habits", 3: "Habits", 4: "Daily Rituals" },
  "daily rituals": { 1: "steps", 2: "habits", 3: "habits", 4: "daily rituals" },
  "Ritual": { 1: "Step", 2: "Habit", 3: "Habit", 4: "Ritual" },
  "ritual": { 1: "step", 2: "habit", 3: "habit", 4: "ritual" },
  "Rituals": { 1: "Steps", 2: "Habits", 3: "Habits", 4: "Rituals" },
  "rituals": { 1: "steps", 2: "habits", 3: "habits", 4: "rituals" },
...
export function calculateLanguageStage(
  ...
  if (!isOnboardingComplete && onboardingDay <= 5) return 1;
  if (totalCompletionDays < 14 || streak < 7) return 2;
  if (totalCompletionDays >= 28 && streak >= 14) return 4;
  return 3;
}
