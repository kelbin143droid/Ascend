...
// Route pages are code-split so the first mobile bundle stays focused on home/onboarding.
...
const WeeklyPlanningPage = React.lazy(() => import("@/pages/WeeklyPlanningPage"));
const TrialsPage = React.lazy(() => import("@/pages/TrialsPage"));
const CalendarPage = React.lazy(() => import("@/pages/CalendarPage"));
const SectographPage = React.lazy(() => import("@/pages/SectographPage"));
const HabitsPage = React.lazy(() => import("@/pages/HabitsPage"));
const NutritionPage = React.lazy(() => import("@/pages/NutritionPage"));
const GuidedSessionPage = React.lazy(() => import("@/pages/GuidedSessionPage"));
const WakeFlowPage = React.lazy(() => import("@/pages/WakeFlowPage"));
