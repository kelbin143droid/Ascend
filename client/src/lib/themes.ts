...
export const themes: AppTheme[] = [
  {
    id: "male",
    name: "Iron Sovereign",
    description: "Mystic forest warrior — ancient woods, gold runes, sky crystal",
    icon: "⚔️",
    darkOverlayOpacity: 0.18,
    gridOpacity: 0.10,
    colors: {
      primary: "#3FB6FF",
      primaryGlow: "rgba(63, 182, 255, 0.55)",
      secondary: "#E8B964",
      accent: "#4ADE80",
      background: "#08141A",
      backgroundGradient:
        "radial-gradient(ellipse at 50% 0%, rgba(63,182,255,0.18) 0%, rgba(15,55,75,0.10) 40%, rgba(8,20,26,1) 75%), radial-gradient(ellipse at 15% 90%, rgba(232,185,100,0.10) 0%, transparent 45%), radial-gradient(ellipse at 85% 95%, rgba(74,222,128,0.10) 0%, transparent 45%), linear-gradient(180deg, #0A1A22 0%, #06121A 100%)",
      surface: "rgba(10, 26, 34, 0.88)",
      surfaceBorder: "rgba(232, 185, 100, 0.40)",
      text: "#E6F4FF",
      textMuted: "rgba(200, 230, 245, 0.55)",
      ring: "#E8B964",
      ringGlow: "rgba(232, 185, 100, 0.50)",
      tickMark: "rgba(232, 185, 100, 0.55)",
      clockHand: "#E8B964",
      centerDot: "#3FB6FF",
    },
  },
