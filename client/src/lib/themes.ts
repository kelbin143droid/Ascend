...
export const themes: AppTheme[] = [
  {
    ...
    colors: {
      ...
      text: "#e8f4ff",
      textMuted: "rgba(200, 230, 255, 0.82)",
      ring: "#38bdf8",
  ...
  },
  {
    ...
    colors: {
      primary: "#22d3ee",
      primaryGlow: "rgba(34, 211, 238, 0.65)",
      secondary: "#a855f7",
      accent: "#22c55e",
      background: "#02060a",
      backgroundGradient:
        "radial-gradient(ellipse at 50% 30%, rgba(14,40,70,0.55) 0%, rgba(2,6,10,1) 70%), linear-gradient(180deg, #02060a 0%, #000000 100%)",
      surface: "rgba(6, 12, 20, 0.78)",
      surfaceBorder: "rgba(34, 197, 94, 0.55)",
      text: "#E6F4FF",
      textMuted: "rgba(200, 230, 245, 0.85)",
      ring: "#22d3ee",
      ringGlow: "rgba(34, 211, 238, 0.55)",
      tickMark: "rgba(34, 211, 238, 0.55)",
      clockHand: "#22d3ee",
      centerDot: "#22c55e",
    },
  },
  ...
  },
  {
    ...
    colors: {
      ...
      surfaceBorder: "rgba(0, 212, 255, 0.45)",
      text: "#ffffff",
  ...
  },
  {
    ...
    colors: {
      ...
      text: "#ffffff",
      textMuted: "rgba(255, 200, 200, 0.82)",
      ring: "#ff3333",
  ...
  },
  {
    ...
    colors: {
      ...
      text: "#e0e0e0",
      textMuted: "rgba(200, 180, 220, 0.82)",
      ring: "#7c3aed",
  ...
  },
  {
    ...
    colors: {
      ...
      text: "#ffffff",
      textMuted: "rgba(255, 220, 240, 0.82)",
      ring: "#f472b6",
  ...
  },
  {
    ...
    colors: {
      ...
      text: "#fff8dc",
      textMuted: "rgba(255, 248, 220, 0.82)",
      ring: "#ffd700",
