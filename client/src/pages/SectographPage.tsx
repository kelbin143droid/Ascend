          ...
          <div
            ...
            style={{
              background: vitalitySleepDone
                ...
                : "linear-gradient(135deg, rgba(8,21,42,0.96), rgba(13,40,72,0.90))",
              border: vitalitySleepDone
                ? "1.5px solid rgba(245,158,11,0.88)"
                : `1.5px solid ${colors.primary}`,
              boxShadow: vitalitySleepDone
                ? "0 0 22px rgba(245,158,11,0.36), inset 0 1px 0 rgba(255,255,255,0.08)"
                : `0 0 22px ${colors.primaryGlow}, inset 0 1px 0 rgba(255,255,255,0.08)`,
            }}
            data-testid="vitality-coach-tooltip"
          >
            <div
              className="absolute left-1/2 top-full h-5 w-px -translate-x-1/2"
              style={{
                background: vitalitySleepDone
                  ? "linear-gradient(180deg, rgba(245,158,11,0.95), transparent)"
                  : `linear-gradient(180deg, ${colors.primary}, transparent)`,
              }}
            />
            <div
              className="absolute left-1/2 top-[calc(100%+15px)] h-2.5 w-2.5 -translate-x-1/2 rotate-45"
              style={{
                borderRight: vitalitySleepDone ? "2px solid rgba(245,158,11,0.95)" : `2px solid ${colors.primary}`,
                borderBottom: vitalitySleepDone ? "2px solid rgba(245,158,11,0.95)" : `2px solid ${colors.primary}`,
              }}
            />
            <div
