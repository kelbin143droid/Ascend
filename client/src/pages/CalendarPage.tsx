...
import { ChevronLeft, ChevronRight, Plus, Clock, Bell, Trash2, Check, X, CalendarDays } from "lucide-react";
      ...
      <div className="flex flex-col gap-4 pt-4 pb-20">
        <div className="flex items-center justify-between">
          <button
            ...
            data-testid="button-back-status"
          >
            <ChevronLeft size={14} />
            Back
          </button>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    outlineColor: isSelected ? colors.primary : undefined,
                  }}
                ...
                >
                  <span
                    ...
                    style={{
                      color: isCurrentDay ? colors.primary : colors.text,
                    }}
                  >
                    {day}
                  </span>
