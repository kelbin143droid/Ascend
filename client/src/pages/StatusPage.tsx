      ...
      >
        ...
        <motion.div variants={item} className="flex justify-center py-2">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-b from-primary/5 via-transparent to-primary/5 rounded-full blur-xl" />
            <Sectograph 
              stats={player.stats} 
        ...
        <motion.div variants={item} className="system-panel p-4 rounded-sm">
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-display text-lg tracking-wider text-primary">STATS</h3>
