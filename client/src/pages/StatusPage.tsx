    ...
    <SystemLayout>
      ...
      <div className="space-y-4">
        ...
        <a
          ...
          className="mx-2 mt-3 block system-panel p-3 rounded-lg border border-red-500/30 hover:border-red-500/50 transition-all group"
          style={{ background: "linear-gradient(135deg, rgba(150,50,50,0.15) 0%, rgba(100,30,80,0.15) 100%)" }}
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-red-500/20 flex items-center justify-center text-xl border border-red-500/30 group-hover:scale-110 transition-transform">
              ⚔️
            </div>
            <div className="flex-1">
              <div className="text-sm font-display text-red-400 group-hover:text-red-300">DUNGEON WAVES</div>
              <div className="text-[10px] text-muted-foreground">3D Action • Fight Waves • Survive</div>
            </div>
            <div className="text-red-500/50 group-hover:text-red-400 transition-colors">→</div>
          </div>
        </a>
      </div>
