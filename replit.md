...
-   **Phase 1 Activities**: Strength Micro Circuit (instruction → push-ups → cardio jog → crunches → rest, ~2 min), Agility (neck rolls + shoulder rolls + forward bend), Calm Breathing (4-2-6 pattern, 2 min), Vitality Check (hydration + sleep).
