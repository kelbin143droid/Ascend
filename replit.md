...
-   **Phase 1 Activities** (flow order): Calm Breathing (4-2-6 pattern, 2 min) → Strength Micro Circuit (push-ups → cardio jog → crunches → rest, ~2 min) → Agility Mobility Flow (neck CW/CCW → shoulder rolls → torso twist → forward fold, ~60-90s) → Vitality Check (hydration + sleep).
